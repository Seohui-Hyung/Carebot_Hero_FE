...
export default function DeleteFamily() {
  ...
  async function handleDeleteFamily() {
    ...
    try {
      const result = await userProgressStore.handleDeleteFamilyInfo(inputPassword.current.value)
  ...
  return (
    <Modal open={userProgressStore.modalProgress === "delete-family"} onClose={userProgressStore.modalProgress === "delete-family" ? userProgressStore.handleCloseModal : null}>
      <div id="signout-form">
