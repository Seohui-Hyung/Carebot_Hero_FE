...
export default function Signup() {
  ...
  return (
    <Modal open={userProgressStore.modalProgress === "sign-up"} onClose={userProgressStore.modalProgress === "sign-up" ? userProgressStore.handleCloseModal : null}>
      <form id="signup-form" onSubmit={handleSubmit}>
        ...
        <div className="signup-control">
          ...
          <div className="signup-wrapper">
            <input id="email" className="email-input" type="email" name="email" ref={emailInput} required />
        ...
        <div className="signup-control-row">
          <div className="signup-control">
            ...
            <input id="password" type="password" name="password" onKeyDown={handleKeyDown} onKeyUp={handleKeyUp} ref={passwordInput} required />

            <div className="login-control-error">{formIsInvalid.password && <p>⚠️ 비밀번호는 8자 이상이어야 합니다.</p>}</div>
          </div>

          {/* 비밀번호 확인 입력 */}
          <div className="signup-control">
            <label htmlFor="confirm-password">비밀번호 확인</label>
            <input id="confirm-password" type="password" name="confirm-password" onKeyDown={handleKeyDown} onKeyUp={handleKeyUp} required />

            <div className="signup-control-error">
              {formIsInvalid.passwordCheck && <p>⚠️ 비밀번호가 일치하지 않습니다.</p>}
