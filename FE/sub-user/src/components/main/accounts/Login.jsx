      ...
      <form id="login-form" onSubmit={handleLogin}>
        ...
        <div className="login-form-row">
          <div className="login-control">
            ...
            <input type="email" name="email" onKeyDown={handleKeyDown} onKeyUp={handleKeyUp} ref={emailInput} />
          ...
          <div className="login-control-error">{isCapsLockOn && <p>⚠️ Caps Lock이 켜져 있습니다!</p>}</div>
        </div>
