...
export default function Signout() {
  ...
  async function handleSignOut() {
    ...
    try {
      const result = await userProgressStore.handleSignOut(inputPassword.current.value)
  ...
  return (
    <Modal open={userProgressStore.modalProgress === "sign-out"} onClose={userProgressStore.modalProgress === "sign-out" ? userProgressStore.handleCloseModal : null}>
      <div id="signout-form">
