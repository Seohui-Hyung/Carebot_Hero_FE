...
export default function KickMember() {
  ...
  async function handleKickMember() {
    ...
    try {
      const response = await userProgressStore.handleKickMember(userProgressStore.selectedModalId, inputPassword.current.value)
  ...
  return (
    <Modal open={userProgressStore.modalProgress === "kick-member"} onClose={userProgressStore.modalProgress === "kick-member" ? userProgressStore.handleCloseModal : null}>
      <div id="signout-form">
